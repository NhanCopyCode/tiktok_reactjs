...
export const HomeIconActive = ({ width = '2.6rem', height = '2.6rem', className }) => {
    return (
...
export const FollowingIconActive = ({ width = '2.6rem', height = '2.6rem', className }) => {
    return (
...
export const LiveIcon = ({ width = '2.6rem', height = '2.6rem', className }) => {
    return (
...
export const LiveIconActive = ({ width = '2.6rem', height = '2.6rem', className }) => {
    return (
        <svg
            width={width}
            data-e2e=""
